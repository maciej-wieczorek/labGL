...
void initShaders(){
    spLambert=new ShaderProgram(ROOT_DIR "res/shaders/v_lambert.glsl",NULL,ROOT_DIR "res/shaders/f_lambert.glsl");
    spConstant=new ShaderProgram(ROOT_DIR "res/shaders/v_constant.glsl",NULL,ROOT_DIR "res/shaders/f_constant.glsl");
}
